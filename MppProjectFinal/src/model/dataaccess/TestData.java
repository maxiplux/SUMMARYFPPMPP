...
public class TestData {
	...
	List<Person> people = new ArrayList<Person>() {
		{
			add(new Person("juan", "Mosquera", "Noul", new Address("calle 26", "48", "Valle", "7600162")));
		}
	};
	...
	public static void main(String[] args) {
		...
		System.out.println(da.readPeopleMap());
	}
	
	///create books
		public void personData() {
			
			DataAccessFacade.loadPersonMap(this.people);
		}
	...
	public void libraryMemberData() {
		...
		Person juan = new Person("juan", "Mosquera", "Noul", new Address("calle 26", "48", "Valle", "7600162"));
